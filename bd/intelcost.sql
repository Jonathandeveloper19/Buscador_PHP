...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-01-2021 a las 18:42:35
...
--
-- Estructura de tabla para la tabla `intelcost_bienes`
--
...
--
-- Volcado de datos para la tabla `intelcost_bienes`
--

INSERT INTO `intelcost_bienes` (`id`, `direccion`, `ciudad`, `telefono`, `codigo_postal`, `tipo`, `precio`) VALUES
(3, 'Ap #325-2507 Quisque Av.', 'Los Angeles', '623-807-2869', '89804', 'Casa de Campo', '$36,087');
...
--
-- Indices de la tabla `intelcost_bienes`
--
ALTER TABLE `intelcost_bienes`
  ADD PRIMARY KEY (`id`);
